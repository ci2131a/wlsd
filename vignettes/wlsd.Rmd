...
The `wlsd` package contains several functions for working with longitudinal survival data. This section will provide a number of working examples in order to explain how to use the package efficiently. Once the package is installed, we can library the package into our loaded memory through 

```{r}
library(wlds)
```

for ease of use. The package includes a data set from . It looks at t
