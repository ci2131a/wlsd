...
Different types of survival models require different formats for their data in order to be applied. Transitioning between formats requires in detailed knowledge of the model assumptions and how variables are treated. The `wlsd` package in R seeks to provide methods for transforming data between usable formats in an effort to ease this process `wlsd` can transition between the counting process format and longitudinal or panel format. 
