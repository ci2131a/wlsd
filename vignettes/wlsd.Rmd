...
One common data setup for survival analysis is the counting process format. This data format is organized by a series of time intervals where the count of the event of interest is assessed at the end of the interval and any explanatory variables are constant over the interval
