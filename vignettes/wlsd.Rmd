...
data0 <- data.frame(sid = c(1,1,1,1,2,2,2,3,3),
                     start = c(0,31,64,96,0,33,59,0,28),
                     status = c(1,1,1,2,1,1,2,1,2))
pander::pandoc.table(data0, style = "rmarkdown", caption = "Table 2: Panel Data")
```
